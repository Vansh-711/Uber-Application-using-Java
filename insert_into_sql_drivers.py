...
for _, row in cities_df.iterrows():
    ...
    for _ in range(5):
        ...
        insert_statements.append(
            f"({id_counter}, '{name}', {age}, '{gender}', {rating}, '{city}', {lat:.6f}, {lng:.6f})"
        )
        id_counter += 1

# Write all INSERTS
sql_dump += "INSERT INTO drivers (id, name, age, gender, rating, city, latitude, longitude) VALUES\n"
